...
# 读取训练数据
def read_all_data():
    dataMat = read_image('C:\\Users\\bb\\PycharmProjects\\handwriting\\t10k-images.idx3-ubyte')
    dataLabel = read_label('C:\\Users\\bb\\PycharmProjects\\handwriting\\t10k-labels.idx1-ubyte')
    data = zip(dataMat, dataLabel)
    sortdata = sorted(data,key=lambda x:x[1])
    return sortdata

if __name__ == '__main__':
    traindataMat = read_image('C:\\Users\\bb\\PycharmProjects\\handwriting\\Data\\train-images.idx3-ubyte')
    traindataLabel = read_label('C:\\Users\\bb\\PycharmProjects\\handwriting\\Data\\train-labels.idx1-ubyte')
    #testdataMat = read_image('C:\\Users\\bb\\PycharmProjects\\handwriting\\t10k-images.idx3-ubyte')
    #testdataLabel = read_label('C:\\Users\\bb\\PycharmProjects\\handwriting\\t10k-labels.idx1-ubyte')
    datasize = 100
    imageMat_0 = []
    index_0 = 0
    flag_0 = True
        ...
        if traindataLabel[i] == 0:
            if flag_0:
                if index_0 > datasize-1:
                    ...
                    print "finish 0"
                    file = open("..\\traindata\\obj_0.dat","wb")
            ...
            if flag_1:
                if index_1 > datasize-1:
                    ...
                    print "finish 1"
                    file = open("..\\traindata\\obj_1.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_1 = False
                else:
            ...
            if flag_2:
                if index_2 > datasize-1:
                    ...
                    print "finish 2"
                    file = open("..\\traindata\\obj_2.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_2 = False
                else:
            ...
            if flag_3:
                if index_3 > datasize-1:
                    ...
                    print "finish 3"
                    file = open("..\\traindata\\obj_3.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_3 = False
                else:
            ...
            if flag_4:
                if index_4 > datasize-1:
                    ...
                    print "finish 4"
                    file = open("..\\traindata\\obj_4.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_4 = False
                else:
            ...
            if flag_5:
                if index_5 > datasize-1:
                    ...
                    print "finish 5"
                    file = open("..\\traindata\\obj_5.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_5 = False
                else:
            ...
            if flag_6:
                if index_6 > datasize-1:
                    ...
                    print "finish 6"
                    file = open("..\\traindata\\obj_6.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_6 = False
                else:
            ...
            if flag_7:
                if index_7 > datasize-1:
                    ...
                    print "finish 7"
                    file = open("..\\traindata\\obj_7.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_7 = False
                else:
            ...
            if flag_8:
                if index_8 > datasize-1:
                    ...
                    print "finish 8"
                    file = open("..\\traindata\\obj_8.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_8 = False
                else:
            ...
            if flag_9:
                if index_9 > datasize-1:
                    ...
                    print "finish 9"
                    file = open("..\\traindata\\obj_9.dat","wb")
                    pickle.dump(image,file)
                    file.close()
                    flag_9 = False
                else:
